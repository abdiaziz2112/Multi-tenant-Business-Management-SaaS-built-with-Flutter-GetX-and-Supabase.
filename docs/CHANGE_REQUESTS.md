...
| CR-9 | 2026-07 | Gate B.2 conflict resolution: 6-field registration retained (D37); auth package minimally extended (entity prefill fields, resendSignupOtp, resolver inputs) | auth pkg + business_app | Approved per conflict rule |
