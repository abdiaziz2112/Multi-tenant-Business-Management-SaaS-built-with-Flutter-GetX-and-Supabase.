...
void main() {
  ...
  test('changePassword: verify -> update -> revokeOtherDevices order', () async {
    ...
    final c = PasswordController(
        auth: auth,
        devices: devices,
        getFingerprint: () async => 'fp-current');
    ...
    expect(auth.calls, containsAllInOrder(['verifyRecovery:123456', 'updatePassword']));
